...
We collected data from a total of XX participants. After exclusions based on non-completion or missing data (**details to be expanded**) we analysed data from `r demo$demographics$n` participants (age *M* = `r demo$demographics$age_mean`, *SD* = `r demo$demographics$age_sd`, Range = `r demo$demographics$age_min`, ``r demo$demographics$age_max`). On average participants took `r demo$demographics$duration_mean` seconds to complete the task (*SD* = `r demo$demographics$duration_sd`).
