...
r_file_list <- list.files(
  path = here::here("02_data", "03_study-03", "02_cleaned", "02_aggregated"), 
  pattern = "rds$",
  full.names = TRUE
)
...
model_file_list <- list.files(
  path = here::here("04_analysis", "03_study-03", "01a_models"), 
  pattern = "rds$",
  full.names = TRUE
)
...
data_file_list <- list.files(
  path = here::here("02_data", "03_study-03", "04_model-data"), 
  pattern = "rds$",
  full.names = TRUE
)
