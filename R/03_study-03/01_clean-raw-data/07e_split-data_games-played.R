...
agg_data$social_media_wide <- wide_data_complete %>% 
  select(
    ...
    hours_watching_during,
    hours_interacting_watching_during,
    hours_interacting_watching_during_duplicate
  )
...
agg_data$social_media_long <- agg_data$social_media_wide %>% 
  pivot_longer(
    cols = c(
      hours_watching_before:hours_interacting_watching_during_duplicate
    ),
