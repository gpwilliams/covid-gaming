...
raw_data_renamed <- raw_data %>% 
  ...
  rename(
    ...
    hours_interacting_watching_during = q38_1_1, # new
    hours_watching_during = q43, # new
    hours_interacting_watching_during_duplicate = q41_1, # new
  ...
  rename(loneliness_during_1 = loneliness_during_1_1) # new; fix name
