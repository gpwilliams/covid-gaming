...
r_file_list <- list.files(
  path = here::here("02_data", "02_study-02", "02_cleaned", "02_aggregated"), 
  pattern = "rds$",
  full.names = TRUE
)
...
model_file_list <- list.files(
  path = here::here("04_analysis", "02_study-02", "01a_models"), 
  pattern = "rds$",
  full.names = TRUE
)
...
data_file_list <- list.files(
  path = here::here("02_data", "02_study-02", "04_model-data"), 
  pattern = "rds$",
  full.names = TRUE
)
